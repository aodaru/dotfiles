...
name: exceljs
description: |
  ExcelJS library for creating and styling Excel files. Use when:
  (1) Creating Excel files (.xlsx) with custom styles (colors, fonts, borders, alignment)
  (2) Applying conditional formatting or color coding to cells
  (3) Generating multi-sheet Excel reports with formatting
  (4) Replacing SheetJS (xlsx) when styles are needed
  (5) Creating professional Excel reports with headers, footers, and auto-filters
---
