...
Todo componente y hook público tiene al menos un test en `tests/` que:

1. Cubre el camino feliz (render + interacción).
...
- ❌ Testear implementación (estado interno, métodos privados). → testea
  comportamiento visible (render, interacción).
