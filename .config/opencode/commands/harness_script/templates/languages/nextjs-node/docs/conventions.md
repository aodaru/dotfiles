...
## Estilo Next.js / TypeScript

- **Versión:** Node.js 18+ / Next.js 14+ / TypeScript 5+.
- **Formato:** ESLint + Prettier + strict. Líneas máximo 100 caracteres.
- **Imports:** ESM (`import`/`export`). Path aliases con `@/`.
...
- Tests unitarios: `tests/<módulo>.test.ts(x)`.
- Tests E2E: `e2e/<feature>.spec.ts` con Playwright.
- Componentes: `@testing-library/react` + vitest.
...
export default function Counter() {
  ...
  // Solo lógica interactiva del cliente
}
```
